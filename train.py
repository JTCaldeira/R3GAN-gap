...
@click.option('--wandb_projname',   help='Name of the project for wandb logging',               type=str, required=True)
@click.option('--wandb_groupname',  help='Name of the wandb group in which to include this run',type=str, required=True)
